...
public class CollectionValue {
	...
	public void setAdministration_finances(double administration_finances) {
		this.administration_finances = administration_finances;
	}
	...
	public void setRecreation_culture(double recreation_culture) {
	...
	public void setTransport_infrastructure(double transport_infrastructure) {
		this.transport_infrastructure = transport_infrastructure;
	}
	public double getUrban_planning_housing() {
		return urban_planning_housing;
	}
	public void setUrban_planning_housing(double urban_planning_housing) {
		this.urban_planning_housing = urban_planning_housing;
	}
